...
const Product = (props) => {
  ...
  return (
    <div className="flex w-full h-full min-w-full p-2 my-2 border rounded-xl">
      <div className="flex items-center min-w-full">
        <div className="w-full p-2 px-4">
          ...
          <p className="w-full mt-2 text-sm text-justify text-gray-500 md:text-base">
            {props.description}
          </p>
          <div className="flex items-center justify-end min-w-full text-gray-500">
